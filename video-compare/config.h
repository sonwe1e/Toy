...
enum class SyncMode { FrameIndex, Timestamp };
...
struct VideoCompareConfig {
  ...
  // Eleven decoded frame pairs provide the default current +/- 5 window.
  size_t frame_buffer_size{11};
  size_t frame_prefetch_count{5};
  SyncMode sync_mode{SyncMode::FrameIndex};
